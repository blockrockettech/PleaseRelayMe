...
module.exports = async function (deployer, network, accounts) {
    ...
    await deployer.deploy(MockLiquidityProvider, {from: accounts[0]});
    const liquidityProvider = await MockLiquidityProvider.deployed();
    ...
    await deployer.deploy(rDAIRelayHub, DAI, rDAI, liquidityProvider.address, {from: accounts[0]});
    const hub = await rDAIRelayHub.deployed();
